...
contract User_Con {
    ...
    // Defining an Object from the Company Smart Contract
    Company_Con public _company = new Company_Con();
    ...
    function verify_product(bytes32 product_add) external view returns (uint, string memory, string memory, string memory, string memory, string memory) {
        ...
        Company_Con.Product memory product = _company.get_product(product_add);
